	...
	public static void totalSum(int[][] mat) {
		if (mat.length == 0) {
			...
			for (int i = 1; i < mat.length; i++) {
				// System.out.println("Elements added: " + "row " + i + " col 0, " + "row 0 col
				// " + i + ", row " + i + " col " + i);
				// System.out.println("Elements added: " + mat[i][0] + ", " + mat[0][i] + ", " +
				// mat[i][i]);
				sum = sum + mat[i][0];
				sum = sum + mat[0][i];
				sum = sum + mat[i][i];
			...
			for (int i = 1; i < mat[0].length - 1; i++) {
				// System.out.println("Elements added: " + "row " + (mat[0].length-1) + " col "
				// + i + ", row " + i + " col " + (mat[0].length-1));
				// System.out.println("Elements added: " + mat[mat[0].length-1][i] + ", " +
				// mat[i][mat[0].length-1]);
